#!/usr/bin/env python3
"""
BioScript - SVG İkon yaratma
BioScript loqosuna uyğun barmaq izi ikonu
"""

def create_bioscript_icon():
    """BioScript üçün SVG icon yaradır"""
...
if __name__ == "__main__":
    icon_content = create_bioscript_icon()
    with open("bioscript_icon.svg", "w", encoding="utf-8") as f:
        f.write(icon_content)
    print("BioScript ikonu yaradıldı: bioscript_icon.svg")