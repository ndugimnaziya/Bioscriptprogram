...
-- Üretim Zamanı: 21 Tem 2025, 14:39:39
...
--
-- Tablo döküm verisi `prescriptions`
--

INSERT INTO `prescriptions` (`id`, `doctor_id`, `patient_id`, `hospital_id`, `status`, `issued_at`, `expires_at`, `complaint`, `diagnosis`) VALUES
(1, 16, 'PAT001', 6, 'active', '2025-07-21 12:09:42', NULL, 'Başı ağrıyır.', 'Baş ağrısı dərmanı'),
(2, 16, 'PAT001', 6, 'active', '2025-07-21 12:24:17', NULL, 'Qıçı ağrıyır.', 'Qıçı çıxıb.'),
(3, 16, 'PAT001', 6, 'active', '2025-07-21 12:37:43', NULL, 'Başı yenə ağrıyır', 'Miqrein var');
...
--
-- Tablo döküm verisi `prescription_items`
--

INSERT INTO `prescription_items` (`id`, `prescription_id`, `name`, `dosage`, `instructions`) VALUES
(1, 1, 'Spazmazor', '1', 'İçmək - 1 gün'),
(2, 2, 'Sümük dırmanı', '1', 'normal - 12.07.2025'),
(3, 3, 'tylol hot', '1', 'seherleri iç - 1 gün');
