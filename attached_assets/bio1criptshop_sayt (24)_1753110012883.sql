...
-- Üretim Zamanı: 21 Tem 2025, 18:00:04
...
(16, 'Hüseyn', 'Tahirov', 'Ramil', '5ZZ2AZV', 'Cərrah', 'https://i.hizliresim.com/k91avjm.png', 0, 'huseyn', 'huseyn', '2025-07-20 12:18:38', 6, 1, 'Paid');
...
('PAT171', 'Hüseyn Tahirov', '5zz2azv', '2009-09-19', '+994605285505', 'Ordubad rayonu', '2025-07-21 16:06:45', '2025-07-21 16:06:45', '2025-07-21 16:06:45');
...
INSERT INTO `payments` (`id`, `entity_type`, `entity_id`, `amount`, `month`, `status`, `paid_at`, `created_at`, `currency`, `description`, `receipt_url`) VALUES
(5, 'Doctor', 16, 20.00, '2025-07', 'Paid', '2025-07-21 14:29:42', '2025-07-21 14:29:42', 'AZN', 'Monthly Subscription Fee', NULL);
